...
<table class="data">
    <thead>
        <tr class="mode">
            ...
            <th class="lang java" >
                <input id="javaCheck" type="radio" name="tab_item" checked>
                <label class="tab_item checkBox" for="javaCheck">JAVA</label>
            </th>

            <th class="lang php" >
                <input id="phpCheck" type="radio" name="tab_item" checked> 
                <label class="tab_item checkBox" for="phpCheck">PHP</label>
            </th>

            <th class="lang python">
                <input id="pythonCheck" type="radio" name="tab_item" checked> 
        ...
        <tr class="level">
            ...
            <th>
                <input id="eazy" type="radio" name="tab_item2" checked> 
                <label class="tab_item checkBox2" for="eazy">イージー</label>
            </th>

            
            <th>
                <input id="normal" type="radio" name="tab_item2" checked> 
                <label class="tab_item checkBox2" for="normal">ノーマル</label>
            </th>

            
            <th>
                <input id="hard" type="radio" name="tab_item2" checked> 
